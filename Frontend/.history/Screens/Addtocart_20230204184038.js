...
const Addtocart = () => {
  ...
  return (
    ...
    <View style={{ paddingTop: 40, flex: 1, backgroundColor: 'snow', height: '100%', }}>
      ...
      <TouchableOpacity style={{ alignItems: 'center', width: 300, borderWidth: 1,marginTop:20,backgroundColor:'black'  }}><Text style={{fontSize:20}}>Checkout</Text></TouchableOpacity>
      </View>
    </View>
  )
}
