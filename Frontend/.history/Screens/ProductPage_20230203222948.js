            ...
            <ScrollView style={styles.container}>
                ...
                <View >
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                        <View style={{ flexDirection: 'row', marginLeft: 10 }}>
                            <TouchableOpacity onPress={minushandle}
                                style={{ backgroundColor: 'steelblue', width: 50, borderTopLeftRadius: 5, borderBottomLeftRadius: 5 }}>
                                <Text style={styles.btntxt}>
                                    -
                                </Text></TouchableOpacity>
                            <Text style={{ fontSize: 30, width: 50, textAlign: 'center' }}>{itemcount}</Text>
                        ...
                        <View style={{ marginRight: 5 }}>
                            <Text style={{ fontSize: 28, fontWeight: '500' }}>Rs.{item.price}</Text>
                        </View>
                    </View>
                    ...
                    <View style={{ alignItems: 'center' }}>
                        <TouchableOpacity onPress={} style={styles.button}><Text style={styles.addtxt}>
                            ADD TO CART
                        </Text></TouchableOpacity>
                    </View>
                </View>
