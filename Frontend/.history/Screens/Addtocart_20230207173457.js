...
const Addtocart = ({navigation}) => {
  ...
  return (
    ...
    <View style={{ paddingTop: 40, flex: 1, backgroundColor: 'snow', height: '100%', }}>
      ...
      <TouchableOpacity onPress={()=>{navigation.navigate('checkout')}} style={{ alignItems: 'center', width: 300, borderWidth: 1,marginTop:50,backgroundColor:'black',height:40,borderRadius:10  }}>
        <Text style={{fontSize:20,color:'white',paddingTop:5}}>Checkout</Text></TouchableOpacity>
      </View>
    </View>
  )
}
