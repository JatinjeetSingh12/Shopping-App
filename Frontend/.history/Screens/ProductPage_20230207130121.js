...
const ProductPage = ({ navigation, route }) => {
    ...
    return (
        <>
            ...
            <View style={{width:40,borderWidth:1,alignItems:'center',position:'relative',bottom:290,borderRadius:10,left:10,backgroundColor:'black'}}>
            <AntDesign onPress={()=>{navigation.navigate('home')}}  name="back" size={28} color="white" />
            </View>
